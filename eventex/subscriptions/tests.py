...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Lucas Fontes', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('lucas@fontes.net', email.body)
...
class SubscribeInvalidPost(TestCase):
    ...
    #garantir que o formulário correto esteja no contexto pra renderizar o template
    #Para exibir os erros
    def test_has_form(self):
        form = self.resp.context['form']
        self.assertIsInstance(form, SubscriptionForm)

    #Garantir que o formulário temha os erros
